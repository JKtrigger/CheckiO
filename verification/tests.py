    ...
    "Basics": [
        {
            "input": (['Norwegian-Dunhill','Marlboro-blue','Brit-3',
                    ...
                    'yellow-cat','Winfield-Swede','tea-Marlboro'],['fish-colors']),
            "answer": "green"
        },
            ...
            
        {
            "input": (['Norwegian-Dunhill','Marlboro-blue','Brit-3',
                    ...
                    'bird-Brit','4-green','Winfield-beer',
                    'Dane-blue','5-dog','blue-horse',
                    'yellow-cat','Winfield-Swede','tea-Marlboro'],['Brit-cigarettes'])
            "answer": 'Pall Mall'
        },
         {
            "input": (['Norwegian-Dunhill','Marlboro-blue','Brit-3',
                    ...
                    'bird-Brit','4-green','Winfield-beer',
                    'Dane-blue','5-dog','blue-horse',
                    'yellow-cat','Winfield-Swede','tea-Marlboro'],['coffee-colors'])
            "answer": 'green'
        },
